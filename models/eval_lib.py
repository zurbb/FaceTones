...
def load_validation_data(limit_size:int, batch_size:int, use_dino:bool)->torch.utils.data.DataLoader:
    ...
    validation_data = get_train_loader(num_workers=1,images_dir=test_images_dir, voices_dir=test_voices_dir, batch_size=batch_size, limit_size=limit_size, dino=use_dino)
