...
#SBATCH --error=logs/error_only_linear_bigger_05_dropout_32_BS.txt
...
/cs/ep/120/playground/Voice-Image-Classifier/.venv/bin/python3 /cs/ep/120/playground/Voice-Image-Classifier/models/training.py \
    ...
    --batch_size=32 \
    --run_name=only_linear_bigger_05_dropout_32_BS \
    --epochs=20 \
    --num_workers=12 \
    --description="only linear bigger model , lr=0.00001, with more drop-out 0.5 and batch size 32" 